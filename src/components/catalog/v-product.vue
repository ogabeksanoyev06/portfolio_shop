				...
				<div class="tabs_content">
					...
					<div class="tab_pane" v-show="isActive(2)">
						<div class="row">
							<div class="col-md-6">
								<div class="rewievs">
									<p class="rewievs_title mb-5">2 Reviews for lira earings</p>
									<div class="mt-3">
										<div class="d-flex align-items-center mb-3">
											<p class="rewievs_title me-2 mb-0">Scarlet withch</p>
										...
										<p class="rewievs_text">
											...
											Veritatis officiis minima eos non eius fuga quidem
										</p>
									</div>
									<hr />
									<div>
										...
										<p class="rewievs_text">
											Lorem ipsum dolor sit amet consectetur adipisicing elit.
											Veritatis officiis minima eos non eius fuga quidem,
											voluptatum dicta excepturi vel doloremque nisi, deserunt
											error nobis pariatur illum tenetur voluptas dolore.
										</p>
									</div>
								</div>
							</div>
